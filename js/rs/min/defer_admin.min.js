...
e.effects.save(o,r),o.show(),s=e.effects.createWrapper(o).css({overflow:"hidden"}),a="IMG"===o[0].tagName?s:o,n=a[c](),l&&(a.css(c,0),a.css(p,n/2)),f[c]=l?n:0,f[p]=l?0:n/2,a.animate(f,{queue:!1,duration:t.duration,easing:t.easing,complete:function(){l||o.hide(),e.effects.restore(o,r),e.effects.removeWrapper(o),i()}})},e.effects.effect.drop=function(t,i){var s,a=e(this),n=["position","top","bottom","left","right","opacity","height","width"],o=e.effects.setMode(a,t.mode||"hide"),r="show"===o,h=t.direction||"left",l="up"===h||"down"===h?"top":"left",u="up"===h||"left"===h?"pos":"neg",d={opacity:r?1:0};e.effects.save(a,n),a.show(),e.effects.createWrapper(a),s=t.distance||a["top"===l?"outerHeight":"outerWidth"](!0)/2,r&&a.css("opacity",0).css(l,"pos"===u?-s:s),d[l]=(r?"pos"===u?"+=":"-=":"pos"===u?"-=":"+=")+s,a.animate(d,{queue:!1,duration:t.duration,easing:t.easing,complete:function(){"hide"===o&&a.hide(),e.effects.restore(a,n),e.effects.removeWrapper(a),i()}})},e.effects.effect.explode=function(t,i){function s(){b.push(this),b.length===d*c&&a()}function a(){p.css({visibility:"visible"}),e(b).remove(),m||p.hide(),i()}var n,o,r,h,l,u,d=t.pieces?Math.round(Math.sqrt(t.pieces)):3,c=d,p=e(this),f=e.effects.setMode(p,t.mode||"hide"),m="show"===f,g=p.show().css("visibility","hidden").offset(),v=Math.ceil(p.outerWidth()/c),y=Math.ceil(p.outerHeight()/d),b=[];for(n=0;d>n;n++)for(h=g.top+n*y,u=n-(d-1)/2,o=0;c>o;o++)r=g.left+o*v,l=o-(c-1)/2,p.clone().appendTo("body").wrap("<div></div>").css({position:"absolute",visibility:"visible",left:-o*v,top:-n*y}).parent().addClass("ui-effects-explode").css({position:"absolute",overflow:"hidden",width:v,height:y,left:r+(m?l*v:0),top:h+(m?u*y:0),opacity:m?0:1}).animate({left:r+(m?0:l*v),top:h+(m?0:u*y),opacity:m?1:0},t.duration||500,t.easing,s)},e.effects.effect.fade=function(t,i){var s=e(this),a=e.effects.setMode(s,t.mode||"toggle");s.animate({opacity:a},{queue:!1,duration:t.duration,easing:t.easing,complete:i})},e.effects.effect.fold=function(t,i){var s,a,n=e(this),o=["position","top","bottom","left","right","height","width"],r=e.effects.setMode(n,t.mode||"hide"),h="show"===r,l="hide"===r,u=t.size||15,d=/([0-9]+)%/.exec(u),c=!!t.horizFirst,p=h!==c,f=p?["width","height"]:["height","width"],m=t.duration/2,g={},v={};e.effects.save(n,o),n.show(),s=e.effects.createWrapper(n).css({overflow:"hidden"}),a=p?[s.width(),s.height()]:[s.height(),s.width()],d&&(u=parseInt(d[1],10)/100*a[l?0:1]),h&&s.css(c?{height:0,width:u}:{height:u,width:0}),g[f[0]]=h?a[0]:u,v[f[1]]=h?a[1]:0,s.animate(g,m,t.easing).animate(v,m,t.easing,function(){l&&n.hide(),e.effects.restore(n,o),e.effects.removeWrapper(n),i()})},e.effects.effect.highlight=function(t,i){var s=e(this),a=["backgroundImage","backgroundColor","opacity"],n=e.effects.setMode(s,t.mode||"show"),o={backgroundColor:s.css("backgroundColor")};"hide"===n&&(o.opacity=0),e.effects.save(s,a),s.show().css({backgroundImage:"none",backgroundColor:t.color||"#ffff99"}).animate(o,{queue:!1,duration:t.duration,easing:t.easing,complete:function(){"hide"===n&&s.hide(),e.effects.restore(s,a),i()}})},e.effects.effect.size=function(t,i){var s,a,n,o=e(this),r=["position","top","bottom","left","right","width","height","overflow","opacity"],h=["position","top","bottom","left","right","overflow","opacity"],l=["width","height","overflow"],u=["fontSize"],d=["borderTopWidth","borderBottomWidth","paddingTop","paddingBottom"],c=["borderLeftWidth","borderRightWidth","paddingLeft","paddingRight"],p=e.effects.setMode(o,t.mode||"effect"),f=t.restore||"effect"!==p,m=t.scale||"both",g=t.origin||["middle","center"],v=o.css("position"),y=f?r:h,b={height:0,width:0,outerHeight:0,outerWidth:0};"show"===p&&o.show(),s={height:o.height(),width:o.width(),outerHeight:o.outerHeight(),outerWidth:o.outerWidth()},"toggle"===t.mode&&"show"===p?(o.from=t.to||b,o.to=t.from||s):(o.from=t.from||("show"===p?b:s),o.to=t.to||("hide"===p?b:s)),n={from:{y:o.from.height/s.height,x:o.from.width/s.width},to:{y:o.to.height/s.height,x:o.to.width/s.width}},("box"===m||"both"===m)&&(n.from.y!==n.to.y&&(y=y.concat(d),o.from=e.effects.setTransition(o,d,n.from.y,o.from),o.to=e.effects.setTransition(o,d,n.to.y,o.to)),n.from.x!==n.to.x&&(y=y.concat(c),o.from=e.effects.setTransition(o,c,n.from.x,o.from),o.to=e.effects.setTransition(o,c,n.to.x,o.to))),("content"===m||"both"===m)&&n.from.y!==n.to.y&&(y=y.concat(u).concat(l),o.from=e.effects.setTransition(o,u,n.from.y,o.from),o.to=e.effects.setTransition(o,u,n.to.y,o.to)),e.effects.save(o,y),o.show(),e.effects.createWrapper(o),o.css("overflow","hidden").css(o.from),g&&(a=e.effects.getBaseline(g,s),o.from.top=(s.outerHeight-o.outerHeight())*a.y,o.from.left=(s.outerWidth-o.outerWidth())*a.x,o.to.top=(s.outerHeight-o.to.outerHeight)*a.y,o.to.left=(s.outerWidth-o.to.outerWidth)*a.x),o.css(o.from),("content"===m||"both"===m)&&(d=d.concat(["marginTop","marginBottom"]).concat(u),c=c.concat(["marginLeft","marginRight"]),l=r.concat(d).concat(c),o.find("*[width]").each(function(){var i=e(this),s={height:i.height(),width:i.width(),outerHeight:i.outerHeight(),outerWidth:i.outerWidth()};f&&e.effects.save(i,l),i.from={height:s.height*n.from.y,width:s.width*n.from.x,outerHeight:s.outerHeight*n.from.y,outerWidth:s.outerWidth*n.from.x},i.to={height:s.height*n.to.y,width:s.width*n.to.x,outerHeight:s.height*n.to.y,outerWidth:s.width*n.to.x},n.from.y!==n.to.y&&(i.from=e.effects.setTransition(i,d,n.from.y,i.from),i.to=e.effects.setTransition(i,d,n.to.y,i.to)),n.from.x!==n.to.x&&(i.from=e.effects.setTransition(i,c,n.from.x,i.from),i.to=e.effects.setTransition(i,c,n.to.x,i.to)),i.css(i.from),i.animate(i.to,t.duration,t.easing,function(){f&&e.effects.restore(i,l)})})),o.animate(o.to,{queue:!1,duration:t.duration,easing:t.easing,complete:function(){0===o.to.opacity&&o.css("opacity",o.from.opacity),"hide"===p&&o.hide(),e.effects.restore(o,y),f||("static"===v?o.css({position:"relative",top:o.to.top,left:o.to.left}):e.each(["top","left"],function(e,t){o.css(t,function(t,i){var s=parseInt(i,10),a=e?o.to.left:o.to.top;return"auto"===i?a+"px":s+a+"px"})})),e.effects.removeWrapper(o),i()}})},e.effects.effect.scale=function(t,i){var s=e(this),a=e.extend(!0,{},t),n=e.effects.setMode(s,t.mode||"effect"),o=parseInt(t.percent,10)||(0===parseInt(t.percent,10)?0:"hide"===n?0:100),r=t.direction||"both",h=t.origin,l={height:s.height(),width:s.width(),outerHeight:s.outerHeight(),outerWidth:s.outerWidth()},u={y:"horizontal"!==r?o/100:1,x:"vertical"!==r?o/100:1};a.effect="size",a.queue=!1,a.complete=i,"effect"!==n&&(a.origin=h||["middle","center"],a.restore=!0),a.from=t.from||("show"===n?{height:0,width:0,outerHeight:0,outerWidth:0}:l),a.to={height:l.height*u.y,width:l.width*u.x,outerHeight:l.outerHeight*u.y,outerWidth:l.outerWidth*u.x},a.fade&&("show"===n&&(a.from.opacity=0,a.to.opacity=1),"hide"===n&&(a.from.opacity=1,a.to.opacity=0)),s.effect(a)},e.effects.effect.puff=function(t,i){var s=e(this),a=e.effects.setMode(s,t.mode||"hide"),n="hide"===a,o=parseInt(t.percent,10)||150,r=o/100,h={height:s.height(),width:s.width(),outerHeight:s.outerHeight(),outerWidth:s.outerWidth()};e.extend(t,{effect:"scale",queue:!1,fade:!0,mode:a,complete:i,percent:n?o:100,from:n?h:{height:h.height*r,width:h.width*r,outerHeight:h.outerHeight*r,outerWidth:h.outerWidth*r}}),s.effect(t)},e.effects.effect.pulsate=function(t,i){var s,a=e(this),n=e.effects.setMode(a,t.mode||"show"),o="show"===n,r="hide"===n,h=o||"hide"===n,l=2*(t.times||5)+(h?1:0),u=t.duration/l,d=0,c=a.queue(),p=c.length;for((o||!a.is(":visible"))&&(a.css("opacity",0).show(),d=1),s=1;l>s;s++)a.animate({opacity:d},u,t.easing),d=1-d;a.animate({opacity:d},u,t.easing),a.queue(function(){r&&a.hide(),i()}),p>1&&c.splice.apply(c,[1,0].concat(c.splice(p,l+1))),a.dequeue()},e.effects.effect.shake=function(t,i){var s,a=e(this),n=["position","top","bottom","left","right","height","width"],o=e.effects.setMode(a,t.mode||"effect"),r=t.direction||"left",h=t.distance||20,l=t.times||3,u=2*l+1,d=Math.round(t.duration/u),c="up"===r||"down"===r?"top":"left",p="up"===r||"left"===r,f={},m={},g={},v=a.queue(),y=v.length;for(e.effects.save(a,n),a.show(),e.effects.createWrapper(a),f[c]=(p?"-=":"+=")+h,m[c]=(p?"+=":"-=")+2*h,g[c]=(p?"-=":"+=")+2*h,a.animate(f,d,t.easing),s=1;l>s;s++)a.animate(m,d,t.easing).animate(g,d,t.easing);a.animate(m,d,t.easing).animate(f,d/2,t.easing).queue(function(){"hide"===o&&a.hide(),e.effects.restore(a,n),e.effects.removeWrapper(a),i()}),y>1&&v.splice.apply(v,[1,0].concat(v.splice(y,u+1))),a.dequeue()},e.effects.effect.slide=function(t,i){var s,a=e(this),n=["position","top","bottom","left","right","width","height"],o=e.effects.setMode(a,t.mode||"show"),r="show"===o,h=t.direction||"left",l="up"===h||"down"===h?"top":"left",u="up"===h||"left"===h,d={};e.effects.save(a,n),a.show(),s=t.distance||a["top"===l?"outerHeight":"outerWidth"](!0),e.effects.createWrapper(a).css({overflow:"hidden"}),r&&a.css(l,u?isNaN(s)?"-"+s:-s:s),d[l]=(r?u?"+=":"-=":u?"-=":"+=")+s,a.animate(d,{queue:!1,duration:t.duration,easing:t.easing,complete:function(){"hide"===o&&a.hide(),e.effects.restore(a,n),e.effects.removeWrapper(a),i()}})},e.effects.effect.transfer=function(t,i){var s=e(this),a=e(t.to),n="fixed"===a.css("position"),o=e("body"),r=n?o.scrollTop():0,h=n?o.scrollLeft():0,l=a.offset(),u={top:l.top-r,left:l.left-h,height:a.innerHeight(),width:a.innerWidth()},d=s.offset(),c=e("<div class='ui-effects-transfer'></div>").appendTo(document.body).addClass(t.className).css({top:d.top-r,left:d.left-h,height:s.innerHeight(),width:s.innerWidth(),position:n?"fixed":"absolute"}).animate(u,t.duration,t.easing,function(){c.remove(),i()})}});
function isInArray(e,t){return t.indexOf(e)>-1}var stateArray=["AL","AK","AZ","AR","CA","CO","CT","DE","FL","GA","HI","ID","IL","IN","IA","KS","KY","LA","ME","MD","MA","MI","MN","MS","MO","MT","NE","NV","NH","NJ","NM","NY","NC","ND","OH","OK","OR","PA","RI","SC","SD","TN","TX","UT","VT","VA","WA","WV","WI","WY"],caStateArray=["AB","BC","MB","NB","NL","NS","NT","NU","ON","PE","QC","SK","YT"];$.formUtils.addValidator({name:"phone",validatorFunction:function(e,t){if("US"==t.closest("fieldset").find(".input--country").val()){t.attr("data-validation-error-msg","Please enter your phone number in the format xxx-xxx-xxxx"),e=e.trim();var s=new RegExp(/^\(?([0-9]{3})\)?[-. ]?([0-9]{3})[-. ]?([0-9]{4})$/);if(s.test(e)){var i=e.replace(s,"$1-$2-$3");return t.val(i),!0}return!1}return t.attr("data-validation-error-msg","Please enter your phone number"),!0},errorMessageKey:"badPhone"}),$.formUtils.addValidator({name:"customzip",validatorFunction:function(e,t){return"US"==t.closest("fieldset").find(".input--country").val()?(t.attr("data-validation-error-msg","Please enter your 5 digit ZIP"),/(^\d{5}$)/.test(e)?!0:!1):(t.attr("data-validation-error-msg","Please enter your ZIP"),!0)},errorMessageKey:"customzip"}),$.formUtils.addValidator({name:"customstate",validatorFunction:function(e,t){if("US"==t.closest("fieldset").find(".input--country").val()){t.attr("data-validation-error-msg","Please enter your 2 letter state code");var s=e.toUpperCase();return t.val(s),isInArray(s,stateArray)?!0:!1}if("CA"==t.closest("fieldset").find(".input--country").val()){t.attr("data-validation-error-msg","Please enter your 2 letter state code");var s=e.toUpperCase();return t.val(s),isInArray(s,caStateArray)?!0:!1}return t.attr("data-validation-error-msg","Please enter your state"),!0},errorMessageKey:"customstate"}),$.formUtils.addValidator({name:"has-store-type",validatorFunction:function(e,t){var s=t.closest(".field").find("input:checked").length;return s>0?!0:!1},errorMessageKey:"noStoreType"}),$.validate({onError:function(){$(".address:visible").find(".field").each(function(){$(this).stop(!0,!0).slideDown(350,function(){$(this).closest("fieldset").find(".legend").removeClass("rolled")})})},onSuccess:function(){$("input").each(function(){$(this).val($(this).val().replace(/\\/g,""))})}}),$("#custno").on("keyup blur",function(){var e=new Object;e.custNo=$.trim($(this).val());var t="parm="+encodeURIComponent(escape(JSON.stringify(e)));$("#custno-result").html("Searching&hellip;").removeClass("form-error").removeClass("form-valid"),""!=$.trim($(this).val())?$.ajax({url:"/ajax/survey/get_customer",async:!0,type:"POST",cache:!1,data:t,success:function(e){var t=JSON.parse(e);if(t.Result===!0)$("#custno").removeClass("error"),$("#custno-result").html('"'+t.Customer.Name+'" found - Please continue with form').addClass("form-valid").removeClass("form-error");else{$("#custno").addClass("error");var s="Customer could not be found";t.Message&&(s=t.Message),$("#custno-result").html(s).removeClass("form-valid").addClass("form-error")}},error:function(){$("#custno-result").html("Server error, Please try again").removeClass("form-valid").addClass("form-error")}}):$("#custno-result").html("").removeClass("form-valid").addClass("form-error")}),$("#custno").focus(),$("#survey-form form").submit(function(){return $("#custno-result").hasClass("form-valid")?void 0:($("#custno").trigger("focus"),!1)}),$(".checkbox-wrap__input input").change(function(){$(this).is(":checked")?$(this).parent().parent().parent().addClass("selected"):$(this).parent().parent().parent().removeClass("selected");var e=$(this).closest("fieldset").find(".input--is-ship-to").prop("checked"),d = $(this).closest("fieldset").find(".input--is-delete").prop("checked"),t=$(this).closest("fieldset").find(".input--is-store").prop("checked");1==e&&1==t?$(this).closest("fieldset").find(".name label").html("Ship-to/store name"):1==e?$(this).closest("fieldset").find(".name label").html("Ship-to name"):1==t?$(this).closest("fieldset").find(".name label").html("Store name"):$(this).closest("fieldset").find(".name label").html("Ship-to/store name <em>(please select above)</em>")}),$(".address .legend").click(function(){$(this).closest("fieldset").find(".field").each(function(){$(this).is(":visible")?$(this).stop(!0,!0).slideUp(350,function(){$(this).closest("fieldset").find(".legend").addClass("rolled")}):($(this).stop(!0,!0).slideDown(350),$(this).closest("fieldset").find(".legend").removeClass("rolled"))})}),$("#add-address").click(function(e){$(".address:visible").last().find(".field").each(function(){$(this).stop(!0,!0).slideUp(350,function(){$(this).closest("fieldset").find(".legend").addClass("rolled")})});var t=$(".address:visible").last().next();t.slideDown(350),t.find(".enabled").prop("checked",!0),t.find(".input--is-ship-to, .input--is-store").attr("data-validation","has-store-type"),t.find(".field").slideDown(350),t.find(".legend").removeClass("rolled"),t.hasClass("address--10")&&$("#add-address").addClass("is-hidden"),$("#remove-address").removeClass("is-hidden"),e.preventDefault()}),$("#remove-address").click(function(e){var t=$(".address:visible").last();t.hasClass("address--"+$("#Addresscount").val())||(t.find('input[type="checkbox"]').prop("checked",!1).parent().parent().parent().removeClass("selected"),t.find(".ship-to-name, .store-name").hide(),t.find(".input--is-ship-to, .input--is-store").attr("data-validation",""),t.slideUp(90),t.hasClass("address--"+(parseInt($("#Addresscount").val())+1).toString())&&$("#remove-address").addClass("is-hidden")),$("#add-address").removeClass("is-hidden"),e.preventDefault()}),$(".input--address").blur(function(){""!=$.trim($(this).val())?$(this).closest(".address").find(".legend h4 span").html(": "+$(this).val()):$(this).closest(".address").find(".legend h4 span").html("")}),$(".input--country").change(function(){var e=$(this).closest(".address").find(".input--state").first();"US"==$(this).val()?$.formUtils.suggest(e,stateArray):"CA"==$(this).val()?$.formUtils.suggest(e,caStateArray):$.formUtils.suggest(e,"")});var table=$("#datatable").dataTable({deferRender:!1,pageLength:25});$("#datatable tbody").on("click","tr",function(){$(this).toggleClass("selected"),$("#datatable tr.selected").length?$('#export-selected input[type="submit"], #hide-selected input[type="submit"]').prop("disabled",!1):$('#export-selected input[type="submit"], #hide-selected input[type="submit"]').prop("disabled",!0)}),$("#datatable_filter input").on("change",function(){""!=$.trim($(this).val())?$('#export-filtered input[type="submit"], #hide-filtered input[type="submit"]').prop("disabled",!1):$('#export-filtered input[type="submit"], #hide-filtered input[type="submit"]').prop("disabled",!0)}),$("a.popup").on("click",function(){return $("#dialog").find(".popup-address").remove(),$(this).next(".popup-address").clone().appendTo("#dialog").removeClass("is-hidden"),$("#dialog").removeClass("is-hidden").dialog({minWidth:1000,modal:!0,draggable:!1,closeText:"<i class='icon-cross'></i>",open:function(){$(".ui-widget-overlay").bind("click",function(){$("#dialog").dialog("close")})},show:{effect:"fade",duration:90},hide:{effect:"fade",duration:90}}),!1}),table.on("draw.dt",function(){$("a.popup").off("click").on("click",function(){return $("#dialog").find(".popup-address").remove(),$(this).next(".popup-address").clone().appendTo("#dialog").removeClass("is-hidden"),$("#dialog").removeClass("is-hidden").dialog({minWidth:500,maxHeight:500,modal:!0,draggable:!1,closeText:"<i class='icon-cross'></i>",open:function(){$(".ui-widget-overlay").bind("click",function(){$("#dialog").dialog("close")})},show:{effect:"fade",duration:90},hide:{effect:"fade",duration:90}}),!1})}),$("#export-all").submit(function(){}),$("#export-filtered").submit(function(){$('#export-filtered input[type="hidden"]').remove();for(var e=table._("tr",{filter:"applied"}),t=0;t<e.length;t++)$("#export-filtered").append('<input type="hidden" name="records[]" value="'+e[t][0]+'">')}),$("#export-selected").submit(function(){$('#export-selected input[type="hidden"]').remove();for(var e=table._("tr.selected"),t=0;t<e.length;t++)$("#export-selected").append('<input type="hidden" name="records[]" value="'+e[t][0]+'">')}),$("#hide-all").submit(function(){}),$("#hide-filtered").submit(function(){$('#hide-filtered input[type="hidden"]').remove();for(var e=table._("tr",{filter:"applied"}),t=0;t<e.length;t++)$("#hide-filtered").append('<input type="hidden" name="records[]" value="'+e[t][0]+'">')}),$("#hide-selected").submit(function(){$('#hide-selected input[type="hidden"]').remove();for(var e=table._("tr.selected"),t=0;t<e.length;t++)$("#hide-selected").append('<input type="hidden" name="records[]" value="'+e[t][0]+'">')});$(".address:visible").find(".field").each(function() {$(this).stop(!0, !0).slideUp(350, function() {$(this).closest("fieldset").find(".legend").addClass("rolled")})});$("#custno").blur();